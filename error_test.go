...
func TestRuntimeError_Error_EmptyMessage_NilError(t *testing.T) {
	...
	assert.True(t, strings.HasSuffix(line, "error_test.go:67"))
	//
	line = lines[2]
...
func TestRuntimeError_Error_EmptyMessage_NormalError(t *testing.T) {
	...
	assert.True(t, strings.HasSuffix(line, "error_test.go:89"))
	//
	line = lines[3]
	assert.True(t, strings.HasPrefix(line, "   at testing.tRunner() in "))
	//
...
func TestRuntimeError_Error_NormalMessage_NilError(t *testing.T) {
	...
	assert.True(t, strings.HasSuffix(line, "error_test.go:125"))
	//
	line = lines[2]
	assert.True(t, strings.HasPrefix(line, "   at testing.tRunner() in "))
	//
...
func TestRuntimeError_Error_NormalMessage_NormalError(t *testing.T) {
	...
	assert.True(t, strings.HasSuffix(line, "error_test.go:147"))
	//
	line = lines[3]
	assert.True(t, strings.HasPrefix(line, "   at testing.tRunner() in "))
	//
...
func TestRuntimeError_Error_MainGoid(t *testing.T) {
	...
	assert.True(t, strings.HasSuffix(line, "error_test.go:207"))
	//
	line = lines[2]
	assert.True(t, strings.HasPrefix(line, "   at testing.tRunner() in "))
}
...
func TestRuntimeError_Error_ZeroGopc(t *testing.T) {
	...
	assert.True(t, strings.HasSuffix(line, "error_test.go:224"))
	//
	line = lines[2]
	assert.True(t, strings.HasPrefix(line, "   at testing.tRunner() in "))
}
...
func TestArgumentNilError_Error(t *testing.T) {
	...
	assert.True(t, strings.HasSuffix(line, "error_test.go:300"))
	//
	line = lines[4]
	assert.True(t, strings.HasPrefix(line, "   at testing.tRunner() in "))
	//
